...
const createUser = () => {
  ...
  if (username.value === undefined) {
    alertMessage.value = 'Nie podałeś nazwy użytkownika'
    ...
    AuthStore.register(email.value, username.value, password.value, false).then(() => {
...
<template>
  <div class="container flex flex-col justify-center items-center text-2xl max-h-screen gap-6 h-full">
    ...
    <div class="justify-center items-center flex flex-col gap-4">
      <p class="text-4xl font-bold">Tworzysz nowego użytkownika</p>
      <p class="text-xl text-gray-400">Użytkownik musi potwierdzić email</p>
    </div>
